...
public class Trace {
	...
	public static class Creator {
		...
		public Creator(String serviceName) {
			try {
				String ip = InetAddressUtilities.toString(InetAddressUtilities.getLocalHostLANAddress());
	...
	private Trace(Creator creator) {
		serverTracer = ServerTracer.create(ServerSpanAndEndpoint.create(creator.state), creator.spanIdGenerator, creator.spanCollector, creator.sampler);
		clientTracer = ClientTracer.create(ClientSpanAndEndpoint.create(creator.state), creator.spanIdGenerator, creator.spanCollector, creator.sampler);
