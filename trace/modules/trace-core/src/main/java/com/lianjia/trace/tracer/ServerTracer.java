...
public class ServerTracer extends AnnotationSubmitter {
	...
	public void setStateCurrentTrace(String traceId, String spanId, String parentSpanId, String name) {
		getSpanAndEndpoint().state().setCurrentServerSpan(ServerSpan.create(traceId, spanId, parentSpanId, name));
	}

	public void setStateNoTracing() {
		getSpanAndEndpoint().state().setCurrentServerSpan(ServerSpan.NOT_SAMPLED);
	}
	...
	public void setStateUnknown(String spanName) {
		...
		getSpanAndEndpoint().state().setCurrentServerSpan(ServerSpan.create(newTraceId, newTraceId, null, spanName));
	}
